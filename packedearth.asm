...
gfiller: #transfer data in RAM to LCD
    li a1, RAM
    li a3, RAM + 25600
gloopa:
    lbu a0, 0(a1)
...
gfx_data:
include_bytes earth2prep.dat
#https://commons.wikimedia.org/wiki/File:Reversed_Earth_map_1000x500.jpg
